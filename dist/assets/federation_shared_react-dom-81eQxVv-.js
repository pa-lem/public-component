...
} from "./federation_shared_react-DYlhdcjt.js";
...
function Uc(a, b, c, d, e) {
  switch (b) {
    ...
    case "gotpointercapture":
      return (
        (f = e.pointerId), Pc.set(f, Tc(Pc.get(f) || null, a, b, c, d, e)), !0
      );
  }
  return !1;
}
  ...
  function n(e, g, h, k) {
    ...
    if (null === u) {
      for (; w < h.length; w++)
        (u = q(e, h[w], k)),
          null !== u &&
            ((g = f(u, g, w)), null === m ? (l = u) : (m.sibling = u), (m = u));
      I && tg(e, w);
      return l;
    }
...
function ui(a, b, c) {
  if (0 === (Hh & 21))
    return (
      a.baseState && ((a.baseState = !1), (dh = !0)), (a.memoizedState = c)
    );
...
export { index as default, reactDomExports as r };
