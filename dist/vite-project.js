...
function lr() {
  ...
  function P(b, c, T) {
    ...
    T !== void 0 && (R = "" + T), c.key !== void 0 && (R = "" + c.key), c.ref !== void 0 && (W = c.ref);
    for (p in c)
      m.call(c, p) && !I.hasOwnProperty(p) && (h[p] = c[p]);
    if (b && b.defaultProps)
      for (p in c = b.defaultProps, c)
        h[p] === void 0 && (h[p] = c[p]);
    return { $$typeof: w, type: b, key: R, ref: W, props: h, _owner: A.current };
  }
...
function cr() {
  return Se || (Se = 1, process.env.NODE_ENV !== "production" && function() {
    var M = Ce, w = Symbol.for("react.element"), U = Symbol.for("react.portal"), m = Symbol.for("react.fragment"), A = Symbol.for("react.strict_mode"), I = Symbol.for("react.profiler"), P = Symbol.for("react.provider"), b = Symbol.for("react.context"), c = Symbol.for("react.forward_ref"), T = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), h = Symbol.for("react.memo"), R = Symbol.for("react.lazy"), W = Symbol.for("react.offscreen"), Q = Symbol.iterator, we = "@@iterator";
    function Pe(e) {
    ...
    function Ie(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === m || e === I || Ae || e === A || e === T || e === p || Fe || e === W || xe || ke || De || typeof e == "object" && e !== null && (e.$$typeof === R || e.$$typeof === h || e.$$typeof === P || e.$$typeof === b || e.$$typeof === c || // This needs to include all possible module reference object
...
var vr = Z.exports;
const pr = () => /* @__PURE__ */ vr.jsx("div", { children: "Remote component here" });
export {
  pr as RemoteComponent
};
